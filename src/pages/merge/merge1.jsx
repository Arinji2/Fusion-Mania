      ...
      <div className="relative h-fit w-full md:h-[87vh]">
        ...
        <div className="flex w-full flex-col items-center justify-center pb-10">
          <p
            className={
              loaded
                ? "z-30 w-fit rounded-lg border-2 border-theme-30 bg-theme-30 p-2 text-[20px] text-white transition-all duration-300 ease-in-out hover:cursor-pointer hover:bg-white hover:text-theme-30 md:pr-4 md:pl-4 md:text-[25px]"
                : "hidden"
            }
            onClick={() => {
